/*
 * gui.h: header file to the gui interface of Drop Four
 *
...
// These functions are called by dropfour-gui.cpp and must be present in some
...
void display( char* boardpos, int col = -1, int humanmove = -1 );
